...
const reviews = [
  ...
  { name: '박*준 원장', business: '치과의원', content: '병원 홈페이지 깔끔하게 잘 만들어주셨어요. 환자분들 반응도 좋습니다.' },
  { name: '최*민 대표', business: '온라인 쇼핑몰', content: '쇼핑몰 리뉴얼했는데 매출이 30% 올랐어요. 디자인이 확실히 다르네요.' },
  { name: '정*수 원장', business: '피부과의원', content: '예약 문의가 확실히 늘었습니다. 모바일에서도 깔끔하게 보여서 만족해요.' },
  { name: '한*진 대표', business: '법률사무소', content: '전문적이면서도 신뢰감 있는 디자인으로 잘 만들어주셨습니다. 추천드려요.' },
  { name: '송*아 실장', business: '네일샵', content: '인스타 감성으로 예쁘게 만들어주셔서 고객분들이 홈페이지 보고 많이 오세요!' },
